...
//                                                .hasAnyRole(USER.name(), ADMIN.name())
                                                ...
                                                // "/api/v1/admin/**").hasAnyAuthority(USER_CREATE.name(),
                                                // ADMIN_CREATE.name())
                                                // .requestMatchers(PUT,
                                                // "/api/v1/admin/**").hasAnyAuthority(USER_UPDATE.name(),
                                                // ADMIN_UPDATE.name())
                                                // .requestMatchers(DELETE,
                                                // "/api/v1/admin/**").hasAnyAuthority(USER_DELETE.name(),
                                                // ADMIN_DELETE.name())
                                                ...
                                                .requestMatchers(POST, "/api/v1/containers")
                                                .hasAnyRole(ADMIN.name(), USER.name())
                                                .requestMatchers(DELETE, "/api/v1/containers/**")
                                                .hasAnyRole(ADMIN.name(), USER.name())

                        ...
                        <div className="flex flex-col md:self-stretch gap-[23px] flex-1">
                          <div className="flex flex-col items-start gap-[7px]">
                            ...
                            <Input
                                ...
                                placeholder={isLocked ? initialData.firstname : 'Enter your first name'}
                                disabled={isLocked}
                                value={firstName}
                          ...
                          <div className="flex flex-col items-start gap-1.5">
                            ...
                            <Input
                                ...
                                name="surname"
                                className="self-stretch sm:px-5 border-black-900_26 border border-solid"
                                placeholder={isLocked ? initialData.lastname : 'Enter your last name'}
                                disabled={isLocked}
                                value={lastName}
                          ...
                          <div className="flex flex-col items-start gap-[7px]">
                            ...
                            <Input
                                ...
                                name="dateOfBirth"
                                className="self-stretch sm:px-5 border-black-900_26 border border-solid"
                                placeholder={isLocked ? initialData.dateofbirth : 'Enter your date of birth'}
                                disabled={isLocked}
                          ...
                          <div className="flex flex-col items-start  gap-[7px]">
                            ...
                            <Input
                                ...
                                name="status"
                                className="self-stretch sm:px-5 border-black-900_26 border border-solid"
                                placeholder={isLocked ? initialData.status : 'Enter your status'}
                                disabled={isLocked}
                                value={status}
                                onChange={setStatus}
                            />
                        ...
                        <div className="md:self-stretch mb-1.5 flex-1">
                          <div className="flex flex-col items-start gap-[7px]">
                            ...
                            <Input
                                ...
                                name="email"
                                className="self-stretch sm:px-5 border-black-900_26 border border-solid"
                                placeholder={isLocked ? initialData.email : 'Enter your email'}
                                disabled={isLocked}
                                value={email}
                                onChange={setEmail}
                            />
                          ...
                          <div className="flex flex-col items-start mt-[18px] gap-[7px]">
                            ...
                            <div style={{ display: showButtons ? 'none' : 'block' }}>
                              ...
                              <div>
                                <Text as="p">Confirm new password</Text>
                                <Input
                                    shape="round"
